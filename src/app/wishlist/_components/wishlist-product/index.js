...
export default function Wishlistproduct() {
  ...
  const moveToCart = (productId, sku, ringSize, engravingText, quantity) => {
    axios.post('/wishlist/api/move-to-cart', {
      productId,
      sku,
      ringSize,
      engravingText,
                  ...
                  <div className="col-span-2">
                    <div>
                      ...
                      <div className="user-actions">
                        ...
                        <Button className='' onClick={() => moveToCart(items?.productId, items?.sku, items?.ringSize, items?.engravingText, items?.quantity)}>Move to cart</Button>
                        <AlertDialog >
                          <AlertDialogTrigger>
