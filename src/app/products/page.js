        ...
        <div className="customization">
          <div className="grid grid-cols-12">
            ...
            <div className='col-span-12'>
              <div className='product-category-name my-5'>
                <div className='name text-center font-crimson text-3xl pb-2 text-accent'>
            ...
            <div className="col-span-12 sticky bottom-0 bg-white z-[2]">
